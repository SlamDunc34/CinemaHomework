...
INSERT INTO movies (title, year, show_time) VALUES ('Guardians of the Galaxy 2', 2016, '12:10');
...
SELECT name FROM people WHERE name = 'Duncan Henderson';
DELETE FROM movies WHERE title = 'Batman Begins';
DELETE FROM people WHERE name = 'Zsolt Podoba-Szalai';
SELECT * FROM people;
UPDATE people SET name = 'Sandy McMillan' WHERE id IN (10);
UPDATE people SET name = 'Darren Breen' WHERE id IN (11);
UPDATE movies SET show_time = '21:30' WHERE title = 'Guardians of the Galaxy 2' AND show_time = '12:10';
